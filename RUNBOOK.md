...
**2. Vulnerabilities.** Read the **Impacted SBOMs** column: **1, 1, 2, 2**.

> "The two attribute-injection CVEs now impact one build. The two sandbox
> escapes still impact both — because the backport fixed the first two and
> never claimed to fix the others."

**3. CVE-2024-22195 → Related SBOMs.** Two rows: `1.1 Affected`, `1.2 Fixed`.
